...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleParse(HttpMessageNotReadableException ex, HttpServletRequest req) {
        return build(BAD_REQUEST, "Malformed JSON", ex.getMostSpecificCause().getMessage(), req, null);
    }

    @ExceptionHandler(DataIntegrityViolationException.class)
    public ResponseEntity<ErrorResponse> handleSql(DataIntegrityViolationException ex, HttpServletRequest req) {
        return build(CONFLICT, "Data Integrity Violation", ex.getMostSpecificCause().getMessage(), req, null);
    }
