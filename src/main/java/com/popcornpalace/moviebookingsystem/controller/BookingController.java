...
/**
 * BookingController is responsible for managing ticket booking in the system. It provides a RESTful
 * API. Each operation is mapped to the conventional HTTP methods in REST: POST for create new
 * ticket booking. Created by Tal Cohen.
 */
@RestController
